...
class General
{
	...
	public function __construct( $productRegistry = array() )
	{
		...
		$this->mod_data = $productRegistry['mod_data'];
		$this->mod_name = $productRegistry['mod_name'];
		$this->mod_file = $productRegistry['mod_file'];
		$this->mod_lang = $productRegistry['mod_lang'];
		$this->lang_data = $productRegistry['lang_data'];
